...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!process.env.AIRTABLE_API_KEY || !process.env.AIRTABLE_BASE_ID || !BBVA_TABLE_ID) {
      console.error('❌ Faltan variables de entorno requeridas para BBVA');
    ...
    await base(BBVA_TABLE_ID)
      ...
      .eachPage((pageRecords, fetchNextPage) => {
        pageRecords.forEach((record) => {
          ...
          console.log('BBVA Field con ID fldlt2Uad6uPbaR0M:', fields['fldlt2Uad6uPbaR0M']);
